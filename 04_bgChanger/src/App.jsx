...
function App() {
  ...
  return (
    ...
    >
      <div className='fixed flex flex-wrap bottom-8 justify-center inset-x-0 px-2'
      >
        <div className='flex flex-wrap bg-white rounded-4xl gap-3 justify-center px-3 py-2 shadow-none'
        >
